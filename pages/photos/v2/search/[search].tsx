...
function SearchPhoto() {
    ...
    const getArticleLists = async (o: any, l: any) => {
        try {
            ...
            const res = await API_URL.get("/api/v1/photos/searchPhotos/" + o + "/" + l + "/" + search)
    ...
    return (
        <div >
            <Head>
                <title>Search Photos - {title}</title>
                <meta name="description" content={"Search Photos - " + title} />
            ...
            <main className='container'>
                ...
                <div className="photos_home">
                    ...
                    <div className="photos_logo">
                        <h1>Search Photos: {title}</h1>
                    </div>

                    <PhotosSearch myProp={title} />
